...
import '/chats_user_and_nurse/chat_details_overlay/chat_details_overlay_widget.dart';
import '/chats_user_and_nurse/chat_thread_component/chat_thread_component_widget.dart';
                ...
                context.pushNamed(
                  ...
                  queryParameters: {
                    ...
                    'callID': serializeParam(
                      widget!.chatRef?.hasGroupChatId()?.toString(),
                      ParamType.String,
                    ),
