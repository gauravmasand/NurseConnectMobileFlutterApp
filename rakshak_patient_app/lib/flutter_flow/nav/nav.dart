...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'successSOS',
          path: '/successSOS',
          builder: (context, params) => SuccessSOSWidget(),
        ),
        FFRoute(
          name: 'chat_2_Details',
          path: '/chat2Details',
        ...
        FFRoute(
          name: 'nurseProfile',
          path: '/nurseProfile',
          builder: (context, params) => NurseProfileWidget(
        ...
        FFRoute(
          name: 'MedisinesSchedule',
          path: '/medisinesSchedule',
          builder: (context, params) => MedisinesScheduleWidget(),
        ),
        FFRoute(
          name: 'VideoCallPage',
          path: '/videoCallPage',
        ...
        FFRoute(
          ...
          path: '/nearByNurses',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'NearByNurses')
              : NearByNursesWidget(),
        )
